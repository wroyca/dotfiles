...
These commands typically insert text or delete characters and should replace
any existing persistent selection with the inserted content (or delete it).
Includes electric commands from various major modes like C-mode.")
